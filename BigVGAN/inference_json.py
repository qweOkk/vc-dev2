...
def inference(a, h):
    ...
    with torch.no_grad():
        ...
        test_wav_output = "/blob/v-shenkai/checkpoints/tts/vocoder/bigvgan/v2/wav_22wstep"
...
def main():
    ...
    parser.add_argument('--checkpoint_file', default="/blob/v-shenkai/checkpoints/tts/vocoder/bigvgan/v2/g_00220000", type=str)
