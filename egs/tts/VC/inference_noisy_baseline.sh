...
exp_name="vc_inference_noisy"

######## Train Model ###########
echo "Exprimental Name: $exp_name"

python "${work_dir}"/models/tts/vc/vc_inference_noisy.py\
    --config $exp_config \
    --exp_name $exp_name \
    --log_level debug \
    ...
    --output_dir "/mnt/data2/hehaorui/vc_test/Results/VCTK_bsl" \
    --cuda_id 6

#/mnt/data2/hehaorui/ckpt/zero-shot/epoch-0000_step-0100000_loss-0.078911/
#/mnt/data2/hehaorui/ckpt/vc/resume_vc_train/checkpoint/epoch-0001_step-0400000_loss-0.037989/
#/mnt/data2/hehaorui/ckpt/vc/sv_se_vc/checkpoint/epoch-0001_step-0344000_loss-0.152027
#/mnt/data2/hehaorui/ckpt/vc/sv_se_vc/checkpoint/epoch-0001_step-0439000_loss-0.125295/